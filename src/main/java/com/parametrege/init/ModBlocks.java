...
public class ModBlocks {
    ...
    // Исправлено: теперь это обычный блок, но со звуком песка, чтобы не было ошибки SandBlock
    ...
    // Исправлено: заменен HalfTransparentBlock на базовый Block
    public static final RegistryObject<Block> MATH_PORTAL = BLOCKS.register("math_portal",
        () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.COLOR_BLUE).noCollission().lightLevel(s -> 15).strength(-1.0F).sound(SoundType.GLASS).noLootTable()));
